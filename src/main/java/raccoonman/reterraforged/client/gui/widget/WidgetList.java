...
public class WidgetList<T extends AbstractWidget> extends ContainerObjectSelectionList<WidgetList.Entry<T>> {
    ...
    public WidgetList(Minecraft minecraft, int width, int totalHeight, int top, int bottom, int slotHeight) {
        // 1.21.1 super call: Minecraft, width, (bottom - top), top, slotHeight
    ...
    public void replaceEntries(List<Entry<T>> toList) {
        super.replaceEntries(toList);
    }
