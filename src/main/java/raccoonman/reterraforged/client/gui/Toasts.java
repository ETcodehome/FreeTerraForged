...
public final class Toasts {
	...
	public static void notify(String message, Component description,SystemToast.SystemToastId id) {
	...
	public static void tryOrToast(String errorMessage, ThrowingRunnable r) {
		try {
			...
			notify(errorMessage, messageComponent, SystemToast.SystemToastId.PACK_LOAD_FAILURE);
		}
	}
