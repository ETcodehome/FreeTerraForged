...
public interface TemplateDecorator<T extends TemplateContext> {
    public static final Codec<TemplateDecorator<?>> CODEC = RTFBuiltInRegistries.TEMPLATE_DECORATOR_TYPE.byNameCodec()
            .dispatch("type",
                    TemplateDecorator::codec,
                    (codec) -> (com.mojang.serialization.MapCodec<? extends TemplateDecorator<?>>) codec
            );
