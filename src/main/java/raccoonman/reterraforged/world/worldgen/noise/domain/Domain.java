...
public interface Domain {
    ...
    public static final Codec<Domain> CODEC = RTFBuiltInRegistries.DOMAIN_TYPE.byNameCodec().dispatch("type", Domain::codec, (codec) -> (com.mojang.serialization.MapCodec<? extends Domain>) codec);
