...
import etcodehome.freeterraforged.world.worldgen.lithostitched.LithostitchedInjectionBridge;
...
public abstract class MixinLithostitchedBiomeInjectorManager {
	...
	private static Object ftf$resolveBiomeInjectorEvent(
	...
	@SuppressWarnings("unchecked")
	private static Object ftf$resolveRegionEvent(
		LithostitchedEvent<?> event,
		RegistryAccess registries,
		Registry<LevelStem> dimensions,
		long seed
	...
	private static BiomeSource ftf$readAcquisitionSource(ChunkGeneratorAccessor accessor) {
	...
	private static void ftf$captureFinalInjectors(
	...
	private static void ftf$retainRuntimeSource(ChunkGeneratorAccessor accessor, BiomeSource source) {
	...
	private static void ftf$retainRuntimeFeatures(
