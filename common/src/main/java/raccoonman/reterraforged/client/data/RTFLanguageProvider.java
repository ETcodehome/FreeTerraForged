...
public final class RTFLanguageProvider {
	...
	public static final class EnglishUS extends LanguageProvider {
		...
		protected void addTranslations() {
			...
			this.add(Tooltips.translationKey(RTFTranslationKeys.GUI_BUTTON_UNDERGROUND_BIOME_BANDING), "Adds vertical variation to cave-biome placement, allowing different cave biomes above and below one another. Turning it off removes this extra variation, but depth and climate can still change the cave biome. Ordinary surface-biome regions are unaffected.");
			...
			this.add(Tooltips.translationKey(RTFTranslationKeys.GUI_SLIDER_UNDERGROUND_BIOME_VERTICAL_SIZE), "Controls how tall underground biome regions are. This includes both cave biomes and ordinary surface biomes below the surface. The maximum is the world's full height.");
